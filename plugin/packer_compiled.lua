...
vim.cmd [[au BufReadPre * ++once lua require("packer.load")({'gitsigns.nvim', 'nvim-surround', 'vim-bbye', 'nvim-autopairs', 'nvim-ts-rainbow'}, { event = "BufReadPre *" }, _G.packer_plugins)]]
